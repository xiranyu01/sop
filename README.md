...
一个轻量的 SOP 客户需求管理工具，用来管理客户、物料、机器型号、场景/任务 SOP 版本、全局字段和客户需求版本。需求可以导出为 `requirement_yaml_v0.5` YAML，也可以导出 PDF 便于沟通和归档。
...
- `requirement_yaml_v0.5`：客户需求 YAML 导出结构版本。
- `task_sop_yaml_v0.3`：任务 SOP YAML 结构版本，附件、示例图和物料图片会输出可访问 URL。
